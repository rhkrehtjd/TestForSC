...
# ╔═╡ 76d85926-7730-4686-bd2d-d552cb459d91
md"""
### ------------------------------------------------------------
"""
...
- motive: 어떠한 (n,m) 이미지를 표현하기 위해서 사실 항상 3xnxm개의 숫자가 필요한 것은 아니다. 
  - 행렬곱과 같은 개념을 이용하면 더 적은 양의 수로도 동일 이미지를 표현 가능!
"""
...
# ╔═╡ c7e81291-f73c-448c-9195-f3e239c8f16f
RGB(0,0,0.5),0.5*RGB(0,0,1)
...
let 
	a = [1,1,1,1] |> float # 아래로 네줄 복사해주는 역할
	b = [0,0,1,1,1,1] |> float # R 역할
	c = [1,1,1,1] |> float # 아래로 네줄 복사해주는 역할
	d = [0,0,1,1,0,0] |> float # G 역할
	e = [1,1,1,1] |> float # 아래로 네줄 복사해주는 역할
...
# ╔═╡ 0bd9ff2d-72a2-4c79-ae33-461fb318db87
RGB(1,0.5,1)
...
# 각 색별로 svd를 수행한 결과가 [R의 SVD ,G의 SVD ,B의 SVD]안에 들어가 있음
...
let 
	...
	ratio =(3024+4032)*rk*3 / (3024*4032*3)
