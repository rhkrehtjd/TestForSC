...
# ╔═╡ 3fe7db05-d1a0-4ef3-ba13-fabdfb6a990b
x=3

# ╔═╡ b8fcf68f-91af-42a8-8c37-28ecf8b3410d
w = @bind wkd Slider(1:0.1:10, show_value=true)

# ╔═╡ 162b2297-be73-4968-8756-e718fa037c74
w

# ╔═╡ f177a2f1-ab79-4253-96c3-b6d3e039cd78
wkd
...
# ╔═╡ d763b0a3-d15d-45c8-85a6-31bdd227ed21
# x=5
# 중복선언 안 되기 때문에 x값 변경해주겠다고 여기서 x=5를 또 선언하면 안 됨
# x값 변경하려면 x셀로 가서 변경해주면 모든 x값들이 변경됨

# ╔═╡ 84584103-cee8-4c4f-a7e2-a8481efb9634
# 이때 x값을 4로 바꾸면 z는 6으로 바뀔 것
...
# k=1 
# k 
# 당연히 이것도 두줄이니 사용할 수 없음

# ╔═╡ 44819d30-cc71-4c6e-848c-92a0ff7870da
q=1;p=2;q+p
#이렇게 선언하는 건 됨.

# ╔═╡ 66289d4c-fa09-4a82-aa7b-057cb34cf6ab
# 또는 이렇게 하나의 셀에 여러 줄의 코드를 작성할 수 있긴 함
begin
	k=1
	k=k+3
	k=k+1
...
# 또는
# 다중 선언시에 그 안에서만 효력을 발휘할 수 있도록 하고싶으르 땐
# 즉, 함수안에서의 지역변수처럼 사용하고 싶을 땐 begin 대신에 let을 사용하면 된다. 

# ╔═╡ 5c1015f7-4197-4359-999f-93ab36a46827
k

# ╔═╡ c8db96ab-2794-42e2-9346-a114cbece3bc
md"현재 k는 $k 입니다.
이렇게 다른 셀에서 정의돼 있는 k를 이용하여 마크다운에 반영할 수 있다."

# ╔═╡ 9af5a8ce-53b9-4a39-8104-57192c2e3404
md"""
---------
"""
...
# ╔═╡ 095b81db-1c14-4147-81da-13868211bbf0
...
end # 이렇게 end로 마무리 해주어야 한다.

# ╔═╡ 0fe071f8-1cd2-495e-8b2d-99576a2e7f29
if chckbx2 
	md"체크박스상태가 $chckbx2 이군요 --> 당신은 체크박스를 선택하였습니다"
end
...
# 기호3을 선택했지만, 기호3으로 vote3에 저장되는 것이 아니라 이재명으로 저장된다

# ╔═╡ d6191b02-9eb6-4d98-ac46-bc6ae2228606
md"##### 다중선택" 

# ╔═╡ 85bc4445-2ef7-4909-b8a6-54ce04e5ea73
@bind enrllmnt MultiSelect(["보험수리학","통계데이터베이스","통계적추론","통계전산"],default=["통계적추론"])

# ╔═╡ a27edb8c-bb0d-4779-ac83-b996d45977ad
# Select와 다른 점
# shift 또는 ctrl 누르고 클릭하면 다중으로 선택할 수 있다.
...
# ╔═╡ 6f18ba55-7431-43ad-a422-4a66bca57728
Plots.plotly()
...
# 따라서 해당 그래프는 (1,4) , (2,2) , (3,4)를 이은 것임.
